...
def main(argv=None):
    ...
    start = datetime(2018, 7, 1, 0, 0)
    stop  = datetime(2018, 7, 5, 23, 59)
    ...
    raw_data = DataStoreModule.RawStore(data_dir)
    ...
    if changes and not noaction:
        ...
        calib_data = DataStoreModule.CalibStore(data_dir)
